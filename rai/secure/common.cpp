...
void rai::genesis::initialize (MDB_txn * transaction_a, rai::block_store & store_a) const
{
	...
	store_a.account_put (transaction_a, genesis_account, { hash_l, genesis_block->hash (), genesis_block->hash (), genesis_block->hashables.balance, rai::seconds_since_epoch (), 1, rai::epoch::epoch_0 });
